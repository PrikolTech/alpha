...
//
//	mockgen -package user_get_by_id -source contract.go -destination contract_mock.go
//

// Package user_get_by_id is a generated GoMock package.
...
func (m *Mockusecase) Handle(ctx context.Context, id uuid.UUID) (*domain.User, error) {
	m.ctrl.T.Helper()
